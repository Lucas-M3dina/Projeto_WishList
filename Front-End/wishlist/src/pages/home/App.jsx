...
import btn from "./Imagens/btn_enviar.svg"
        ...
        <main className="main-desejos">
            <div className="container">
              ...
              <form className="card_input" action="submit" onSubmit={this.cadastrarDesejo}>
                ...
                <button type="submit" disabled={this.state.Desejo === '' || this.state.IdUsuario === '' ? 'none' : ''}><img className="imagem-envio" src={btn} alt="Imagem Botão de deletar" /></button>
              </form>
          </div>
        </main>
        <footer>
